...
[I want to see the result first.](#效果)
...
This means that we can't use variables to splice strings for import, and it's hard to determine where these `locales` are fairly located for different package managers with different directory structures.
