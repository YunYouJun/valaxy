...
function getStore() {
  if (typeof moment_likes === 'undefined')
    throw new Error('The moment_likes KV binding is not configured')
  return moment_likes
}
...
export async function onRequestGet({ request }) {
  try {
    ...
    return json({ error: 'Moment likes are temporarily unavailable' }, 503)
  }
}
