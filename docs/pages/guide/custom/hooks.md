...
| `md:afterRender` | `ctx: MdAfterRenderContext` | Called after a Markdown page has been loaded and its frontmatter/excerpt resolved. `ctx.renderMarkdown` reuses the configured renderer and resolved Vite base for addon-generated HTML. |
