...
#### 获取用户的 Valaxy Config {#获取用户的-valaxy-config}
...
#### 提供 Typed useThemeConfig {#提供-typed-usethemeconfig}
...
#### 获取 Front-matter {#获取-front-matter}
...
### 提醒特殊需求的用户安装第三方插件 {#提醒特殊需求的用户安装第三方插件}
