...
.not-found-orbit {
  ...
  width: min(100%, 360px);
  aspect-ratio: 1;
  border: 1px solid color-mix(in srgb, var(--press-c-brand-1) 26%, transparent);
  border-radius: 50%;
  background:
    radial-gradient(circle at 50% 50%, color-mix(in srgb, var(--press-c-brand-1) 18%, transparent) 0 2px, transparent 3px),
  ...
  box-shadow:
    inset 0 0 56px color-mix(in srgb, var(--press-c-brand-1) 9%, transparent),
    0 28px 80px color-mix(in srgb, var(--press-c-brand-1) 12%, transparent);
}
...
.not-found-orbit::after {
  ...
  position: absolute;
  inset: 12%;
  border: 1px dashed color-mix(in srgb, var(--press-c-text-2) 22%, transparent);
  border-radius: 50%;
