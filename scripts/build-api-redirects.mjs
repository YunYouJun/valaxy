...
const legacy = JSON.parse(await readFile(new URL('../deploy/api-redirects/legacy-pages.json', import.meta.url), 'utf8'))
const output = new URL('../deploy/api-redirects/dist/', import.meta.url)
